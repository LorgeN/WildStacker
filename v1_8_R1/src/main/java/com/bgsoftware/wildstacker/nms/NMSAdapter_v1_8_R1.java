...
public final class NMSAdapter_v1_8_R1 implements NMSAdapter {
    ...
    private static final ReflectMethod<Boolean> IS_DROP_EXPERIENCE = new ReflectMethod<>(EntityLiving.class, "aZ");
    private static final ReflectMethod<String> GET_SOUND_DEATH = new ReflectMethod<>(EntityLiving.class, "bo");
    private static final ReflectMethod<Float> GET_SOUND_VOLUME = new ReflectMethod<>(EntityLiving.class, "bA");
    private static final ReflectMethod<Float> GET_SOUND_PITCH = new ReflectMethod<>(EntityLiving.class, "bB");
    ...
    private static class SyncedCreatureSpawnerImpl extends CraftBlockState implements SyncedCreatureSpawner{
        ...
        public void updateSpawner(SpawnerUpgrade spawnerUpgrade) {
            ...
            if(mobSpawnerAbstract instanceof NMSSpawners_v1_8_R1.StackedMobSpawner){
                ...
                ((NMSSpawners_v1_8_R1.StackedMobSpawner) mobSpawnerAbstract).updateUpgrade(spawnerUpgrade.getId());
            }
            else{
                NBTTagCompound nbtTagCompound = new NBTTagCompound();
        ...
        public SpawnerCachedData readData() {
            MobSpawnerAbstract mobSpawnerAbstract = getSpawner().getSpawner();
            if(mobSpawnerAbstract instanceof NMSSpawners_v1_8_R1.StackedMobSpawner){
                NMSSpawners_v1_8_R1.StackedMobSpawner stackedMobSpawner = (NMSSpawners_v1_8_R1.StackedMobSpawner) mobSpawnerAbstract;
