    ...
    private static class SyncedCreatureSpawnerImpl extends CraftBlockState implements SyncedCreatureSpawner{
        ...
        public void updateSpawner(SpawnerUpgrade spawnerUpgrade) {
            ...
            if(mobSpawnerAbstract instanceof NMSSpawners_v1_9_R1.StackedMobSpawner){
                ((NMSSpawners_v1_9_R1.StackedMobSpawner) mobSpawnerAbstract).minSpawnDelay = spawnerUpgrade.getMinSpawnDelay();
                ((NMSSpawners_v1_9_R1.StackedMobSpawner) mobSpawnerAbstract).maxSpawnDelay = spawnerUpgrade.getMaxSpawnDelay();
                ((NMSSpawners_v1_9_R1.StackedMobSpawner) mobSpawnerAbstract).spawnCount = spawnerUpgrade.getSpawnCount();
                ((NMSSpawners_v1_9_R1.StackedMobSpawner) mobSpawnerAbstract).maxNearbyEntities = spawnerUpgrade.getMaxNearbyEntities();
                ((NMSSpawners_v1_9_R1.StackedMobSpawner) mobSpawnerAbstract).requiredPlayerRange = spawnerUpgrade.getRequiredPlayerRange();
                ((NMSSpawners_v1_9_R1.StackedMobSpawner) mobSpawnerAbstract).spawnRange = spawnerUpgrade.getSpawnRange();
                ((NMSSpawners_v1_9_R1.StackedMobSpawner) mobSpawnerAbstract).updateUpgrade(spawnerUpgrade.getId());
            }
            else{
                NBTTagCompound nbtTagCompound = new NBTTagCompound();
