...
public final class NMSAdapter_v1_15_R1 implements NMSAdapter {
    ...
    private static final ReflectMethod<Float> GET_SOUND_PITCH = new ReflectMethod<>(EntityLiving.class, "dn");
    ...
    private static class SyncedCreatureSpawnerImpl extends CraftBlockEntityState<TileEntityMobSpawner> implements SyncedCreatureSpawner {
        ...
        public void updateSpawner(SpawnerUpgrade spawnerUpgrade) {
            ...
            if(mobSpawnerAbstract instanceof NMSSpawners_v1_15_R1.StackedMobSpawner)
                ((NMSSpawners_v1_15_R1.StackedMobSpawner) mobSpawnerAbstract).updateUpgrade(spawnerUpgrade.getId());
        }
        ...
        public SpawnerCachedData readData() {
            ...
            return new SpawnerCachedData(
                    ...
                    mobSpawnerAbstract instanceof NMSSpawners_v1_15_R1.StackedMobSpawner ?
                            ((NMSSpawners_v1_15_R1.StackedMobSpawner) mobSpawnerAbstract).failureReason : ""
            );
        }
