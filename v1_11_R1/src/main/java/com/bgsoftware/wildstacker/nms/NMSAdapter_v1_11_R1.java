...
import net.minecraft.server.v1_11_R1.BlockRotatable;
...
public final class NMSAdapter_v1_11_R1 implements NMSAdapter {
    ...
    private static final ReflectMethod<SoundEffect> GET_SOUND_DEATH = new ReflectMethod<>(EntityLiving.class, "bX");
    private static final ReflectMethod<Float> GET_SOUND_VOLUME = new ReflectMethod<>(EntityLiving.class, "ci");
    private static final ReflectMethod<Float> GET_SOUND_PITCH = new ReflectMethod<>(EntityLiving.class, "cj");
    ...
    public boolean canSpawnOn(org.bukkit.entity.Entity bukkitEntity, Location location) {
        ...
        return !(entity instanceof EntityInsentient) || (((EntityInsentient) entity).cM() && ((EntityInsentient) entity).canSpawn());
    }
    ...
    public void giveExp(Player player, int amount) {
        ...
        ItemStack mendingItem = EnchantmentManager.b(Enchantments.B, entityPlayer);
    ...
    private static class SyncedCreatureSpawnerImpl extends CraftBlockState implements SyncedCreatureSpawner{
        ...
        public void updateSpawner(SpawnerUpgrade spawnerUpgrade) {
            ...
            if(mobSpawnerAbstract instanceof NMSSpawners_v1_11_R1.StackedMobSpawner){
                ...
                ((NMSSpawners_v1_11_R1.StackedMobSpawner) mobSpawnerAbstract).updateUpgrade(spawnerUpgrade.getId());
            }
            else{
                NBTTagCompound nbtTagCompound = new NBTTagCompound();
        ...
        public SpawnerCachedData readData() {
            MobSpawnerAbstract mobSpawnerAbstract = getSpawner().getSpawner();
            if(mobSpawnerAbstract instanceof NMSSpawners_v1_11_R1.StackedMobSpawner){
                NMSSpawners_v1_11_R1.StackedMobSpawner stackedMobSpawner = (NMSSpawners_v1_11_R1.StackedMobSpawner) mobSpawnerAbstract;
